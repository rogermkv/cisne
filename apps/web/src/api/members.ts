...
export type Member = { id:string; person:{id:string;fullName:string;cpf:string;birthDate:string|null;phone:string|null;email:string|null;city:string|null;photoPath?:string|null;accessEvents?:any[];user?:{id:string;active:boolean}|null}; category:{id:string;name:string;isDependent?:boolean;requiresHolder?:boolean}; titularMemberId?:string|null; titular?:{id:string;person:{fullName:string}}|null; financialResponsible?:{id:string;name:string}|null; relationship?:string|null; registrationNumber:string|null; admissionDate:string; status:string; notes:string|null; access:any; dependents:any[]; charges?:any[] }
