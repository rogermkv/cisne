...
import { VisitorsPage } from './modules/core/visitors/VisitorsPage'
...
const cards: Array<{ section: AdminSection; title: string; description: string; icon: any; tone: string; permission: string }> = [
  ...
  { section: 'events', title: 'Eventos', description: 'Agenda e atividades do clube', icon: CalendarDays, tone: 'blue', permission: 'events.view' },
  ...
  { section: 'visitors', title: 'Visitantes', description: 'Visitantes e convites', icon: Users, tone: 'blue', permission: 'visitors.view' },
]
