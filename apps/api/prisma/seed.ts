...
async function main() {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    const extras = [
      ...
      ['member-paulo-viana','Paulo Viana','00683408690','1985-12-09','55999556705','TemporÃ¡rio','ACTIVE','2023-12-10'],
      ['member-sergio-klein','SÃ©rgio Klein','11952871433','1965-01-30','55999667806','Veterano','ACTIVE','2005-04-15'],
    ]
    const members:any[]=[]
